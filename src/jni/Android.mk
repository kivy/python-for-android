...
REDIRECT_CFLAGS := -include ../android_redirect.h
REDIRECT_LDFLAGS := -L../../build/libs -landroid_redirect

APPLICATION_ADDITIONAL_CFLAGS := -finline-functions -O2 -DSDL_JAVA_PACKAGE_PATH=$(SDL_JAVA_PACKAGE_PATH) -include ../android_redirect.h
